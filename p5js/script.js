...
//             new VectorAtPoint(
//               startPoint,
//               this.velocityVector(startPoint),
//               true,
//             ),
//           ];
...
//         let tempWidth = windowWidth / 2;
//         createCanvas(tempWidth, round((9 / 16) * tempWidth));
//         penGraphCanv = createCanvas(tempWidth, round((9 / 16) * tempWidth));
//
//         CONFIG = {
//           colors: {
...
let sketch = (p) => {
  p.preload = function () {
    CMUFont = p.loadFont('assets/cmu.ttf');
  };

  p.setup = function () {
    let canvasInset = 350;
    let tempWidth = p.windowWidth - canvasInset;
    p.createCanvas(tempWidth, Math.round((9 / 16) * tempWidth));
